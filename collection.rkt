...
(define (collection-filter predicate collection)
  (stream-filter predicate collection))

(define (collection-map procedure collection)
  (stream-map procedure collection))
